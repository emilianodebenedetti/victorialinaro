        ...
        <div className="drawer ">
          ...
          <div className="drawer-side">
            ...
            <ul className="menu p-4 overflow-y-auto w-80 bg-lila">
              ...
              <h2 classNameName="pb-10 px-2 mx-2 text-xl text-white">VICTORIA LINARO</h2>
              <Link to="/" classNameName="nav-link px-8 py-2 text-white link-hover">
                PROYECTOS
              </Link>
              <Link to="/about" classNameName="nav-link px-8 py-2 text-white link-hover">
                ACERCA DE MI 
              </Link>             
              <Link to="/contact" classNameName="nav-link px-8 py-2 text-white link-hover">
                CONTACTO 
              </Link>  
